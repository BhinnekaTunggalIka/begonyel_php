                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/master-data/table/' .$table->id.'/edit') }}" class="btn btn-warning rounded-pill">edit</a>
                                    <form action="{{ url('/master-data/table/' .$table->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('delete')
