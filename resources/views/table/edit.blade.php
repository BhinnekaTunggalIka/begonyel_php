                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control @error('number') is-invalid @enderror" placeholder="Table Number" id="first-name-icon" name="number" value="{{ $table->number }}">
